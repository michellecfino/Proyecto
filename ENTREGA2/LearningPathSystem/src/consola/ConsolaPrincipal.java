...
public class ConsolaPrincipal extends ConsolaBasica
{
     ...
     */
    private final String[] opcionesMenuPrincipal = new String[]{ "Iniciar sesión", "Registrarse", "Cargar gasolinera de un archivo", "Guardar gasolinera a un archivo", "Salir" };
